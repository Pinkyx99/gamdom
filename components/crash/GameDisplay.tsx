...
export const GameDisplay: React.FC<GameDisplayProps> = ({ gameState, countdown, multiplier, cashoutEvents }) => {
    ...
    return (
        <div ref={containerRef} className="bg-[#1A222D] rounded-t-lg relative flex-1 w-full flex items-center justify-center border border-b-0 border-white/5 aspect-[756/495]">
