...
export const MinesControls: React.FC<MinesControlsProps> = ({
    ...
    const handleSetBet = (modifier: 'min' | 'half' | 'double' | 'max') => {
        switch(modifier) {
            ...
            case 'max': setBetAmount(100); break; // Assuming max bet is 100
        }
    }
    ...
    return (
        <div className="w-full max-w-sm lg:w-80 bg-[#202a35] p-5 rounded-xl shadow-2xl border border-gray-700/50 flex-shrink-0">
            ...
            <div className="mt-6 flex items-center space-x-2">
                 <img src="https://i.imgur.com/h7dzwkI.png" alt="Gamdom Logo" className="h-6 w-6" />
                 <span className="font-sans font-extrabold text-xl text-white tracking-tighter">Gamdom</span>
            </div>
